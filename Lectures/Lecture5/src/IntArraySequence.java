...
public class IntArraySequence implements Iterable<Integer>{
	...
	public Iterator<Integer> iterator(){
		...
		return new IntArraySequenceIterator();
	}
	
	///Inner class IntArrayBagIterator
		public class IntArraySequenceIterator implements Iterator<Integer>{
		...
		public IntArraySequence reverse(){
			...
			IntArraySequence output = new IntArraySequence(this.manyItems);
